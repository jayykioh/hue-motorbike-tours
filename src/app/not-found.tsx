...
export default function NotFound() {
  return (
    <html lang="en" className={`${instrumentSerif.variable} ${manrope.variable} antialiased`}>
      <body>
        <main className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-[var(--color-night)]">
